        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href="https://www.facebook.com/ChCentreOzhukur" className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-clinic-100 hover:text-clinic-600 dark:hover:bg-clinic-900/30 dark:hover:text-clinic-400 transition-colors">
                <Facebook size={18} />
              </a>
              ...
              <a href="https://www.instagram.com/chcenterozr" className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-clinic-100 hover:text-clinic-600 dark:hover:bg-clinic-900/30 dark:hover:text-clinic-400 transition-colors">
                <Instagram size={18} />
              </a>
              <a href="#" className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-clinic-100 hover:text-clinic-600 dark:hover:bg-clinic-900/30 dark:hover:text-clinic-400 transition-colors">
                <Linkedin size={18} />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#services" className="text-gray-600 dark:text-gray-300 hover:text-clinic-600 dark:hover:text-clinic-400 transition-colors">Medical shop</a>
              </li>
              <li>
                <a href="#services" className="text-gray-600 dark:text-gray-300 hover:text-clinic-600 dark:hover:text-clinic-400 transition-colors">Labouratory</a>
              </li>
            </ul>
          </div>
...
Kerala, India - 673 642
        ...
        <div className="flex flex-raw  justify-between md:justify-end  pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} CH Centre. All rights reserved.
                <button
              onClick={scrollToTop}
              className="p-2 bg-clinic-100  md:ml-auto dark:bg-gray-800 rounded-full text-clinic-600 dark:text-clinic-400 hover:bg-clinic-200 dark:hover:bg-gray-700 transition-colors ml-2"
